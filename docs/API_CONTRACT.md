...
| PUT  | `/organizers/:id/onboarding/identity`       | 办理身份、本人姓名与身份证号、主办方主体名称、信息真实性确认 | 最新 `OnboardingState`      |
